...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    currency: 'USD',
    images: [
      { src: '/frontside_transparent.webp', alt: 'Created to Create Light Grey hoodie (front)' },
      { src: '/backside_transparent.webp', alt: 'Created to Create Light Grey hoodie (back)' },
    ],
    sizes: ['Small', 'Medium', 'Large', 'XL', '2X', '3X'],
    inventoryBySize: {
      Small: 0,
